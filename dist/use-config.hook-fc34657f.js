import require$$0, { useMemo, useCallback, createContext, useContext } from 'react';
...
function PaginatorItem({ active = false, activeClassName, onClick, children, ...rest }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { onClick, className: active ? activeClassName : "", ...rest, children });
}
function Paginator({ activePage, pageCount, onSetActivePage, config }) {
  ...
  if (_config.pagination.useCustomPagination) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Components.Paginator, { activePage, pageCount, onSetActivePage });
  }
  if (pageCount < 2) {
    return null;
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Components.Paginator, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Components.PaginatorItem, { "data-page": 0, onClick: handleSetActivePage, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Glyphs.FirstPage, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Components.PaginatorItem, { "data-page": activePage - 1, onClick: handleSetActivePage, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Glyphs.PreviousPage, {}) }),
    threshold + activePage >= _config.pagination.maxPagesToShow && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Components.PaginatorItem,
      {
        "data-page": activePage - _config.pagination.maxPagesToShow,
        onClick: handleSetActivePage,
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Glyphs.Ellipsis, {})
      }
    ),
    ...
    threshold + _config.pagination.maxPagesToShow < pageCount && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Components.PaginatorItem,
      {
        "data-page": activePage + _config.pagination.maxPagesToShow,
        onClick: handleSetActivePage,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Components.PaginatorItem, { "data-page": activePage + 1, onClick: handleSetActivePage, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Glyphs.NextPage, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Components.PaginatorItem, { "data-page": pageCount - 1, onClick: handleSetActivePage, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Glyphs.LastPage, {}) })
  ] });
}
...
const DefaultSmartTableConfig = {
  ...
  pagination: {
    ...
    glyphs: {
      FirstPage: () => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "«" }),
      PreviousPage: () => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "‹" }),
      NextPage: () => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "›" }),
      LastPage: () => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "»" }),
      Ellipsis: () => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "..." })
    }
  }
};
...
function SmartTableConfigProvider({ config, children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SmartTableContext.Provider, { value: mergedConfig, children });
}
...
export { DefaultSmartTableConfig as D, Paginator as P, SmartTableContext as S, SmartTableConfigProvider as a, jsxRuntimeExports as j, useConfig as u };
//# sourceMappingURL=use-config.hook-fc34657f.js.map
